    ...
    <nav class="top-bar" data-topbar role="navigation">
      ...
      <!-- Right Nav Section -->
        <ul class="right">
          ...
          <li><a href="cart.php">Pesanan</a></li>
...
include "config.php";
$id = $_GET['id'];
$query_edit = mysqli_query($mysqli,"SELECT * FROM print_kaos WHERE id='$id'") or die(mysql_error());
$nomor = 1;
while ($data = mysqli_fetch_array($query_edit)) {
 ...
 ?>
    ...
    <div class="row" style="margin-top:10px;">
      ...
      <center><h2>Edit Pemesanan Kaos</h2></center>
      <br>
