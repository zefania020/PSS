...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Edit Pesanan || PrintSukaSuka.com</title>
...
include "config.php";
$id = $_GET['id'];
$query_edit = mysqli_query($mysqli,"SELECT * FROM print_spanduk WHERE id='$id'") or die(mysql_error());
$nomor = 1;
while ($data = mysqli_fetch_array($query_edit)) {
 ...
 ?>
    ...
    <div class="row" style="margin-top:10px;">
      ...
      <center><h2>Edit Pemesanan Print Spanduk</h2></center>
      <br>
    ...
    <form name="form1" autocomplete="off" action="printspanduk_controller.php" method="post">     
      <table>
        <tr>
          ...
          <td>:</td>
          <td><input class="input-group" type="file" name="spanduk" accept="img/*" value="<?php echo $data['id']; ?>" /></td>
        ...
        <tr>
          ...
          <td>&nbsp &nbsp &nbsp<input type="int" id="panjang" name="panjang" maxlength="10" onfocus="startCalc();" onblur="stopCalc();" value="<?php echo $data['panjang']; ?>"> / meter <br><br>
            &nbsp &nbsp &nbsp<input type="int" id="lebar" name="lebar" maxlength="10" onfocus="startCalc();" onblur="stopCalc();" value="<?php echo $data['lebar']; ?>"> / meter</td>
