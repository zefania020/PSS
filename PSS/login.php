...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Login || PrintSukaSuka.com</title>
  ...
  <body>
    ...
    <form method="POST" action="verify.php" style="margin-top:30px;">
      <div class="row">
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="email" id="right-label" placeholder="zefania@gmail.com" name="username">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
        ...
        <br>
        <br>
        <center>Belum memiliki akun? <a href="register.php">Daftar Sekarang</a></center>
        <br>
