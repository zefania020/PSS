...
<html class="no-js" lang="en">
 ...
 <?php   
 	...
 	if (isset($_POST['pesan'])){
      ...
      $print_document = "INSERT INTO print_documen (document, jumlah, total, metode, alamat, tanggal) VALUES('$document', '$jumlah', '$total', '$metode', '$alamat', '$tanggal' )";

      if(mysqli_query($mysqli, $print_document )){
...
<br>
<br>
     <a href="dpesanan_doc.php"><center><button>Lihat</button></center></a>
</div>
