...
<html class="no-js" lang="en">
 ...
 <?php   
 	...
 	if (isset($_POST['pesan'])){
      ...
      $print_spanduk = "INSERT INTO print_spanduk (spanduk, jumlah, total, metode, alamat, tanggal, panjang, lebar, kualitas) VALUES('$spanduk', '$jumlah', '$total', '$metode', '$alamat', '$tanggal', '$panjang', '$lebar', '$kualitas')";

      if(mysqli_query($mysqli, $print_spanduk )){
...
<br>
<br>
     <a href="dpesanan_spanduk.php"><center><button>Lihat</button></center></a>
</div>
